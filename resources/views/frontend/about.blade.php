...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row content">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <ul>
                        <li><i class="ti-angle-double-right"></i> Chuyên môn cao, trách nhiệm với khách hàng</li>
                        <li><i class="ti-angle-double-right"></i> Bảo mật cao, không bị đánh cắp thông tin đơn hàng</li>
                    </ul>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-xl-start" data-aos="fade-right" data-aos-delay="150">
                    <img src="frontend/img/about/counts-img.svg" alt="" class="img-fluid">
                </div>
                        ...
                        <div class="row">
                            <div class="col-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Khách hàng</strong> đã chọn.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <span data-toggle="counter-up">285</span>
                                    <p><strong>Dự án</strong> được thực hiện</p>
                                </div>
                            </div>
                            ...
                            <div class="col-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Năm kinh nghiệm</strong> trong nghề</p>
                                </div>
                            </div>
                            ...
                            <div class="col-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Giải thưởng</strong> cao quý</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- End .content-->
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h4 class="title"><a href="">Dịch vụ SEO</a></h4>
                        <p class="description multi-line4">Dịch vụ SEO tổng thể giúp website của bạn đứng top Google với nhiều từ khóa ngách khác nhau, phủ khắp các kênh internet, làm SEO tổng thể là điều cần thiết và bắt buộc đới với bất kỳ website nào muốn phát triển lâu dài.</p>
                    </div>
                </div>

                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                        <div class="icon"><i class="pe-7s-cloud-upload"></i></div>
                        <h4 class="title"><a href="">Phần mềm quản lý nhà trọ</a></h4>
                        <p class="description multi-line4">Một tháng chỉ mất vài phút để quản lý toàn bộ nhà trọ ngay trên điện thoại của bạn.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <h4 class="title"><a href="">Dịch vụ đăng ký website với Bộ Công Thương</a></h4>
                        <p class="description multi-line4">Để đưa website thương mại điện tử vào hoạt động thì chủ sở hữu trang web phải tiến hành thông báo hoặc đăng ký với Bộ Công Thương</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h4 class="title"><a href="">Lập trình ứng dụng di động</a></h4>
                        <p class="description multi-line4">Lĩnh vực xây dựng – thiết kế app moblie hiện nay phát triển bắt kịp với xu thế chung, đáp ứng tốt cho nhu cầu, đòi hỏi thực tế của con người. Trong đó, việc có thể xây dựng những ứng dụng thích hợp đem tới những lợi ích lớn.</p>
                    </div>
                </div>
    ...
    <section id="team" class="team section-bg">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>Đội ngũ</h2>
                <p>Chuyên môn cao, luôn đam mê sáng tạo và tận tâm, trách nhiệm với khách hàng
