...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Chỉnh sửa thông tin sản phẩm <a href="{{route('admin.product.index')}}" class="btn bg-olive margin"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" data-role="tagsinput" id="tags" name="tags" value="{{$product->tags}}" placeholder="Tag kết thúc bởi dấu ,">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
